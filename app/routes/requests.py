...
def create_request():
    ...
    if request.method == "POST":
        ...
        start_value = request.form.get("requested_start", "").strip()
        end_value = request.form.get("requested_end", "").strip()
        ...
        event = db.session.get(Event, event_id_value)
        ...
        if not resource_type:
            flash("Please select a resource type.", "error")
        ...
        try:
            requested_start = datetime.fromisoformat(start_value)
            requested_end = datetime.fromisoformat(end_value)
